...
uses
  ...
  ZAbstractRODataset, ZDataset,StrUtils,
  ClipBrd
  ;
...
procedure Tfrm_form_busca_base.btn_sairClick(Sender: TObject);
begin
   Close;
end;
...
begin
   ...
   if Trim(FSQL_Extra) <> '' then begin
      tab_busca.SQL.Add(' WHERE ' + Trim(FSQL_Extra));
   end;
