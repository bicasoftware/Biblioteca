...
uses
  ...
  Vcl.DBCtrls, ZSqlUpdate, Vcl.ComCtrls, JvExComCtrls, JvUpDown, JvExControls,
  JvDBLookup;
...
type
  Tfrm_cadastro_livros = class(Tfrm_form_cadastro_base)
    ...
    cbx_editora: TJvDBLookupCombo;
    cbx_autor: TJvDBLookupCombo;
    cbx_genero: TJvDBLookupCombo;
    cbx_categoria: TJvDBLookupCombo;
    ...
    procedure cbx_editoraKeyUp(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure cbx_autorKeyUp(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure cbx_generoKeyUp(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure cbx_categoriaKeyUp(Sender: TObject; var Key: Word;
      Shift: TShiftState);
...
procedure Tfrm_cadastro_livros.cbx_autorKeyUp(Sender: TObject; var Key: Word;Shift: TShiftState);
begin
...
procedure Tfrm_cadastro_livros.cbx_categoriaKeyUp(Sender: TObject;var Key: Word; Shift: TShiftState);
begin
   if Key = 113 then begin
...
procedure Tfrm_cadastro_livros.cbx_editoraKeyUp(Sender: TObject; var Key: Word;Shift: TShiftState);
begin
   if Key = 113 then begin
      SubCadastro('Editora','2');
   end;
end;
...
procedure Tfrm_cadastro_livros.cbx_generoKeyUp(Sender: TObject; var Key: Word;Shift: TShiftState);
begin
   if Key = 113 then begin
...
procedure Tfrm_cadastro_livros.edt_quantidadeKeyPress(Sender: TObject; var Key: Char);
begin
   ApenasNumeros(edt_quantidade,Key);
end;

procedure Tfrm_cadastro_livros.FormActivate(Sender: TObject);
begin
   inherited;
   PreecheComboboxSubCadastro(cbx_categoria, '1' ,'Categoria','ID' ,'Descricao');
   PreecheComboboxSubCadastro(cbx_editora  , '2' ,'Editora'  ,'ID' ,'Descricao');
